        ...
        <div class="right_body">
                ...
                <el-row :gutter="10">
                    ...
                    <el-col :xs="24" :sm="24" :md="12" :lg="6">
                        <el-form-item label-width="0" class="t_c">
                            ...
                            <el-button type="default" @click="download_sub">渠道信息下载</el-button>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
            <template>
                <el-table :data="channels_now" border stripe style="width: 100%">
                    ...
                    <el-table-column label="基本信息" resizable min-width="100px">
                        <template scope="scope">
                    ...
                    <el-table-column label="账户信息" resizable min-width="100px">
                        <template scope="scope">
                    ...
                    <el-table-column label="增值产品" resizable min-width="100px">
                        <template scope="scope">
